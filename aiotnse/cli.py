...
async def cli() -> None:
    ...
    async with ClientSession() as session:
        auth = SimpleTNSEAuth(identifier, password, session)
        api = TNSEApi(auth)
...
async def send_readings(api: TNSEApi, identifier: str, accounts: dict[str, Any]) -> None:
...
async def send_readings_lspu(api: TNSEApi, lspu: dict[str, Any], els_id: int | None = None) -> None:
...
async def get_info(api: TNSEApi, identifier: str, accounts: dict[str, Any]) -> None:
    """Get info for each account."""
...
async def get_lspu_info(api: TNSEApi, accounts: dict[str, Any]) -> None:
...
async def get_els_info(api: TNSEApi, accounts: dict[str, Any]) -> None:
...
async def get_receipts(api: TNSEApi, identifier: str, accounts: dict[str, Any]) -> None:
...
async def get_payments(api: TNSEApi, identifier: str, accounts: dict[str, Any]) -> None:
    """Get payments for each account."""
...
async def get_payments_lspu(api: TNSEApi, lspu_list: list | None) -> None:
...
async def get_charges(api: TNSEApi, identifier: str, accounts: dict[str, Any]) -> None:
    """Get charges for each account."""
...
async def get_charges_lspu(api: TNSEApi, lspu_list: list) -> None:
    for lspu in lspu_list:
        try:
...
async def get_client_info(api: TNSEApi, identifier: str) -> None:
    """Get client info for identifier."""
